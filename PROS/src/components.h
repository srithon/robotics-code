...
const float WHEEL_RADIUS = 2.0; //inches
...
const int8_t LEFT_MOTOR_FRONT_PORT = 1;
const int8_t RIGHT_MOTOR_FRONT_PORT = 2;
const int8_t LEFT_MOTOR_BACK_PORT = 3;
const int8_t RIGHT_MOTOR_BACK_PORT = 4;
const int8_t SHOOTER_MOTOR_PORT = 5;
const int8_t ROLLER_MOTOR_PORT = 6;
